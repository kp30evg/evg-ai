      ...
      <div style={{
        ...
        >
          <div style={{
            ...
            <InboxIcon size={40} color={colors.evergreen} />
          </div>
          <h2 style={{
            fontSize: '28px',
            fontWeight: '600',
          ...
          <p style={{
            ...
            Import your Gmail to start managing emails with AI-powered features. Send, receive, and organize emails using natural language.
          </p>
          <motion.button
        ...
        <div style={{
          ...
          {isLoading ? (
            ...
            <div style={{
              ...
              <Mail size={48} color={colors.lightGray} style={{ marginBottom: '16px' }} />
              <p style={{ fontSize: '15px', color: colors.mediumGray }}>No emails in your inbox</p>
            </div>
          ) : (
            emails?.map((email: any) => (
              <motion.div
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  backgroundColor: 
                    selectedEmail?.id === email.id ? colors.softGreen :
                    !email.data.isRead ? '#F0F9FF' : colors.white,
              ...
              >
                <div style={{
                  ...
                  <div style={{
                    ...
                    <span style={{
                      fontSize: '14px',
                      fontWeight: !email.data.isRead ? '600' : '400',
                      color: colors.charcoal,
                      overflow: 'hidden',
                ...
                <div style={{
                  ...
                  <span style={{
                    fontSize: '14px',
                    fontWeight: !email.data.isRead ? '500' : '400',
                    color: !email.data.isRead ? colors.charcoal : colors.mediumGray,
                    overflow: 'hidden',
                    textOverflow: 'ellipsis',
                    whiteSpace: 'nowrap',
                    flex: 1
            ...
            <div style={{
              ...
              <div>
                <span style={{
                  fontWeight: '500',
                  color: colors.charcoal
                }}>{selectedEmail.data.from?.name || 'Unknown'}</span>
                <span style={{
                  color: colors.mediumGray,
                  marginLeft: '8px'
                }}>&lt;{selectedEmail.data.from?.email}&gt;</span>
              </div>
              <span style={{
                color: colors.mediumGray,
                fontSize: '13px'
