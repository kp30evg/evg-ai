...
**Primary Colors**
- **Primary**: `#1D5238` – Main CTAs, brand elements (Evergreen)
- **Primary Dark**: `#0F3D28` – Hover states, emphasis
- **Primary Light**: `#E6F4EC` – Subtle backgrounds, highlights

**Secondary Colors**
- **Secondary**: `#222B2E` – Supporting elements (Charcoal)
- **Secondary Light**: `#334155` – Backgrounds, subtle accents
- **Secondary Pale**: `#F1F5F9` – Selected states, highlights

**Accent Colors**
- **Accent Primary**: `#1D5238` – Important actions, notifications
- **Accent Secondary**: `#10B981` – Success states
- **Gradient Start**: `#1D5238` – For gradient elements (if needed)
- **Gradient End**: `#E6F4EC` – For gradient elements (if needed)
...
**Neutral Palette**
- `Neutral-50`: `#FFFFFF` – Pure white backgrounds
...
- `Neutral-700`: `#374151` – Dark secondary
- `Neutral-800`: `#222B2E` – Primary text (Charcoal)
...
**Type Scale**
- **H1**: `48px/52px, 700, -0.02em` – Page titles, major sections
- **H2**: `36px/40px, 600, -0.01em` – Section headers
- **H3**: `24px/28px, 600, -0.01em` – Subsection headers
- **H4**: `20px/24px, 600, normal` – Card titles
- **H5**: `16px/20px, 600, normal` – Minor headers
- **Body Large**: `18px/28px, 400` – Primary reading text
- **Body**: `16px/24px, 400` – Standard UI text
- **Body Small**: `14px/20px, 400` – Secondary information
- **Caption**: `12px/16px, 500` – Metadata, timestamps
- **Label**: `14px/20px, 500, uppercase` – Form labels
- **Code**: `14px/20px, SF Mono` – Code blocks and technical text
